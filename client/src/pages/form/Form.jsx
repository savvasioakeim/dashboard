    ...
    return (
        <form className="container rounded flex flex-col pb-2 pl-1 pr-1">
            <div className='header pt-20 pb-5 pl-5 pr-5 sm:pl-10 sm:pr-10'>
                <p className='mb-5 text-md sm:text-2xl font-bold '>Sign in to your account</p>
                <div className='emailLabel'>
                    <span className='emailSpan'><label className='text-xs sm:text-base' htmlFor="email">Email</label></span>
                    <input
                        value={email}
                ...
                <div className='mb-2'>
                    <div className='flex flex-row justify-between mt-2 mb-2'>
                        <div><span className='text-xs sm:text-base'>Password</span></div>
                        <div>
                            <span className='text-purple-700 text-xs sm:text-base hover:cursor-pointer'>Forgot your password?</span>
                        </div>
                    </div>
                ...
                <div className='flex items-center mt-1 mb-3'>
                    ...
                    <span className='ml-2 text-xs sm:text-base'>Remember me on this device</span>
                </div>
