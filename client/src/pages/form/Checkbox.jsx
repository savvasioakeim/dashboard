...
function CheckboxWithCheckmark() {
    ...
    return (
        <label className="relative inline-block cursor-pointer outline-none">
            ...
            />
            <span
                className={`w-5 h-5 border-2 rounded-lg border-gray-500 flex items-center justify-center relative transition-all duration-200 ${checked
            ...
            >
                ...
                <svg
                    ...
                    className={`checkmark absolute top-0.4 left-0.4 w-4 h-4 transition-opacity ${checked ? "opacity-100" : "opacity-0"
                        }`}
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
